...
namespace DataAccessLayer
{
    public class EmployeePersonalInfoCRUD
    {
        ...
        public List<EmployeePersonalInfo> GetAllEmployeesPersonalInfo(string sortOrder, string searchString)
        {
            using (var dataContext = new DataContext())
            {
                IEnumerable<EmployeePersonalInfo> EmployeePersonalInfo = (from employeePersonalInfo in dataContext.employeePersonalInfo select employeePersonalInfo);
